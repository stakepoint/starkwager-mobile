...
class AccountSettingsTabletMode extends ConsumerWidget implements PreferredSizeWidget {
...
double getResponsiveWidth(BuildContext context, double originalWidth, {double referenceScreenWidth = 1800}) {
